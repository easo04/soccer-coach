<template>
    <div class="exercices-modal">
        <button type="button" class="btn btn-soccer-coach-action btn-sauvegarder" data-toggle="modal" data-target="#myModalMesFavoris"
            @click="getFavorisByUser()"><i class="fa fa-heart"></i> Mes Favoris</button>
        <div id="myModalMesFavoris" class="modal fade" role="dialog">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Mes favoris</h4>
                        <button type="button" class= "close btn-close" id="closeModalMesFavoris" data-dismiss="modal">&times;</button>              
                    </div>
            ...
            getFavorisByUser(){
                if(this.lstExercices.length === 0){
                    ...
                    axios.get('/favoris/get-favoris-by-user').then(reponse =>{
                        reponse.data.favoris.forEach(exe => {
