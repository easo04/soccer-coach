...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread({
    displayListJoueurs: function displayListJoueurs() {
      var _this$lstJoueurs;

      return (_this$lstJoueurs = this.lstJoueurs) === null || _this$lstJoueurs === void 0 ? void 0 : _this$lstJoueurs.sort(function (a, b) {
        return a.nom > b.nom ? 1 : -1;
      });
    },
    displayListEntraineurs: function displayListEntraineurs() {
      var _this$lstEntraineurs;

      return (_this$lstEntraineurs = this.lstEntraineurs) === null || _this$lstEntraineurs === void 0 ? void 0 : _this$lstEntraineurs.sort(function (a, b) {
        return a.nom > b.nom ? 1 : -1;
      });
    },
    displayListPratiques: function displayListPratiques() {
      var _this$lstPratiques;

      return (_this$lstPratiques = this.lstPratiques) === null || _this$lstPratiques === void 0 ? void 0 : _this$lstPratiques.sort(function (a, b) {
    ...
    displayListMatchs: function displayListMatchs() {
      ...
      return (_this$lstMatchs = this.lstMatchs) === null || _this$lstMatchs === void 0 ? void 0 : _this$lstMatchs.sort(function (a, b) {
        return new Date(a.date_debut) > new Date(b.date_debut) ? 1 : -1;
      });
    }
  }, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapGetters"])(['getDescriptionRoleByKey', 'getDescriptionPositionByKey']), {}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapState"])(['lstJoueurs', 'lstEntraineurs', 'lstMatchs', 'lstPratiques'])),
                    ...
                    _c(
                      ...
                      [
                        ...
                        _vm.lstJoueurs.length > 0
                          ...
                          : _vm._e(),
                        _vm._v(" "),
                        _vm._l(_vm.displayListJoueurs, function(joueur, index) {
                          return _c(
                            "div",
